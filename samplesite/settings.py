...
SECRET_KEY = "django-insecure-!7l72l$fs#c%csh5tspjme(su@4b^3-b257m5(=#!sl9yt+i6="
...
# Добавь роутер для работы с двумя БД
DATABASE_ROUTERS = ['samplesite.routers.MainRouter']

# Настройка временной зоны
TIME_ZONE = 'Europe/Moscow'

# Форматы даты для русского языка
DATE_FORMAT = 'd.m.Y'
